...
s_3.sendto(message_to_send.encode(), (localhost, int(fffff)))
...
for i in range(1, 6): #send 5 times
    ...
    s_3.sendto(string_xxx, (localhost, int(fffff)))
